...
#include <rerail_stretchit_mapping/NavigationAction.h>
#include <nav_msgs/Odometry.h>
...
protected:
    ...
    actionlib::SimpleActionServer<rerail_stretchit_mapping::NavigationAction> as_;
    std::string action_name_;
    rerail_stretchit_mapping::NavigationFeedback feedback_;
    rerail_stretchit_mapping::NavigationResult result_;
...
public:
    ...
    void executeCB(const rerail_stretchit_mapping::NavigationGoalConstPtr &request_goal)
    {
        ros::Rate rate(50.0);
        bool success = true;
