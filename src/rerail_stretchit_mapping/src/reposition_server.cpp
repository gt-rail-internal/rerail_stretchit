...
#include <rerail_stretchit_mapping/RepositionAction.h>
#include <nav_msgs/Odometry.h>
...
protected:
    ...
    actionlib::SimpleActionServer<rerail_stretchit_mapping::RepositionAction> as_;
    std::string action_name_;
    rerail_stretchit_mapping::RepositionFeedback feedback_;
    rerail_stretchit_mapping::RepositionResult result_;
...
public:
    ...
    void executeCB(const rerail_stretchit_mapping::RepositionGoalConstPtr &request_goal)
    {
        ros::Rate rate(50.0);
        bool success = true;
